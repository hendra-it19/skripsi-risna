...
@section('pages')
    <div class="card">
        <div class="card-body">
            ...
            <div>
                <form action="{{ route('solusi-stunting.store') }}" method="post" class="container-fluid">
                    @csrf
                    @method('post')
                    <div class="row">
                        <div class="form-group col-12 col-md-6 mb-3">
                            ...
                            @enderror">
                                ...
                                <option value="pencegahan" @if (old('jenis_saran') == 'pencegahan') selected @endif>Pencegahan
                                </option>
                                <option value="pengobatan" @if (old('jenis_saran') == 'pengobatan') selected @endif>Pengobatan
                                </option>
                            </select>
                            @error('jenis_saran')
